...
export default function Subtask ({parentId, id,content}:ISubtasksProps) {
  ...
  return (
    ...
    last:border-b last:border-light-theme-dark-grayish-blue/25
    ...
    `}>
      ...
      {subtaskState && <input type="text" className={`
        absolute h-full w-5/6 top-0 rounded-lg px-2 outline-hidden text-sm text-light-theme-very-dark-grayish-blue-2
